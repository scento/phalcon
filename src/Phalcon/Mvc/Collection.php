...
class Collection implements CollectionInterface, InjectionAwareInterface, Serializable
{
	...
	*/
	...
	public function getReservedAttributes()
	{
		...
		if(is_null($reserved) === true) { //@note better: is_array($reserved) === false
			$reserved = array('_connection' => true, '_dependencyInjector' => true, 
				'_source' => true, '_operationMade' => true, '_errorMessages' => true);
