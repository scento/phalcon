...
class Cookie implements InjectionAwareInterface
{
	...
	*/
	...
	public function send()
	{
		...
		setcookie((string)$this->_name, (string)$value, (int)$this->_expire,
			(string)$this->_path, (string)$this->_domain, (bool)$this->_secure,
			(bool)$this->_httpOnly);
	...
	public function delete()
	{
		...
		setcookie((string)$this->_name, null, time() - 691200, 
			(string)$this->_path, (string)$this->_domain, (bool)$this->_secure, 
			(bool)$this->_httpOnly);
	}
