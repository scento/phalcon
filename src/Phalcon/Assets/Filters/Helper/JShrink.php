 ...
 * @see https://github.com/tedivm/JShrink/blob/master/src/JShrink/JShrink.php
 */

namespace Phalcon\Assets\Filters\Helper;
...
class JShrink
{
    ...
    /**
     * JShrink::minify takes a string containing javascript and removes
